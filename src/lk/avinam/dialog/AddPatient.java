...
public class AddPatient extends javax.swing.JDialog {
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        try {
            MySQL.executeIUD("INSERT INTO `patient` (`patient_fname`,"
                    + "`patient_lname`,`nic_no`,`phone_no1`,`phone_no2`,"
                    + "`dob`,`address`,`email`,"
                    + "`gender_id`,`ward_type_id`,`room_id`) VALUES ('" + fname + "',"
                    + "'" + lname + "','" + nic + "','" + no1 + "','" + no2 + "','" + dob + "',"
