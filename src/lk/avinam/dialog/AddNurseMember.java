 ...
 * @author abesi
 */
public class AddNurseMember extends javax.swing.JDialog {

    /**
     * Creates new form AddNurseMember
     */
    public AddNurseMember(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNurseMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNurseMember dialog = new AddNurseMember(new javax.swing.JFrame(), true);
