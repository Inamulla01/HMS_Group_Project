...
public class DoctorDashboardAppointment extends javax.swing.JPanel {
    ...
    private void loadDoctorAppointmentDetails (){
        try{
            ResultSet rs = MySQL.executeSearch("SELECT appointment_no,patient_name,appointment_room_no,availability_date,time_slot,appointment_status FROM appointment_view;");
            ...
            dAppointmentTable.setDefaultRenderer(Object.class, columTextCenter);
